...
import com.gabrielbazante.cursomc.domain.Pagamento;
import com.gabrielbazante.cursomc.domain.PagamentoComBoleto;
import com.gabrielbazante.cursomc.domain.PagamentoComCartao;
import com.gabrielbazante.cursomc.domain.Pedido;
import com.gabrielbazante.cursomc.domain.Produto;
import com.gabrielbazante.cursomc.domain.enums.EstadoPagamento;
...
import com.gabrielbazante.cursomc.repositories.ItemPedidoRepository;
import com.gabrielbazante.cursomc.repositories.PagamentoRepository;
import com.gabrielbazante.cursomc.repositories.PedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido ped1 = new Pedido(null, sdf.parse("05/10/2020 12:00"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("05/10/2020 13:00"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("10/10/2020 12:00"), null);
